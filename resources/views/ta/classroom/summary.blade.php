...
<div class="mb-5">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h3 class="text-danger fw-bold m-0" style="color: var(--primary-color) !important; letter-spacing: 0.5px;">KẾT QUẢ TỔNG KẾT LỚP HỌC (TRỢ GIẢNG)</h3>
            <p class="text-muted fw-medium mt-1">Lớp phụ trách: <span class="text-dark fw-bold">{{ $courseClass->class_name }} - {{ $courseClass->course->name ?? 'Chưa cập nhật tên khóa học' }}</span></p>
        </div>
...
{{-- BẢNG DỮ LIỆU ĐỘNG Y HỆT BÊN TEACHER --}}
