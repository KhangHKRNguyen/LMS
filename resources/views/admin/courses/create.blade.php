...
<div class="card shadow-sm border-0 mx-auto mb-5" style="max-width: 750px; border-radius: 8px;">
    <div class="card-body p-5">
        <h4 class="text-center fw-bold mb-5" style="color: #990000; letter-spacing: 0.5px;">THÊM MỚI KHÓA HỌC</h4>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" 
                           placeholder="Ví dụ: Khóa luyện thi IELTS Chuyên Sâu 6.5+" style="height: 44px;" value="{{ old('name') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('duration') is-invalid @enderror" name="duration" 
                           placeholder="Ví dụ: 60 (tương đương 30 buổi 2 tiếng)" style="height: 44px;" value="{{ old('duration') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('output_target') is-invalid @enderror" name="output_target" 
                           placeholder="Ví dụ: Cam kết đầu ra tối thiểu IELTS Band 6.5" style="height: 44px;" value="{{ old('output_target') }}">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="4" 
                              placeholder="Ví dụ: Khóa học bứt tốc giúp học viên nắm vững kỹ năng xử lý cả 4 đề thi IELTS."></textarea>
