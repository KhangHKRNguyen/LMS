...
@section('title', 'Giảng viên - Trang chủ')

@section('teacher_content')
<div class="text-center mb-5">
    <h3 class="fw-bold" style="letter-spacing: 1px; color: #990000;">BẢNG ĐIỀU KHIỂN GIẢNG VIÊN</h3>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="text-muted fw-semibold">Giảng viên: <span class="text-dark">{{ Auth::user()->name }}</span></div>
</div>
